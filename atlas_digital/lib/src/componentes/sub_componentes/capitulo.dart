            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: capitulo.capaUrl != null
                    ? DecorationImage(image: NetworkImage(capitulo.capaUrl!), fit: BoxFit.cover)
                    : null,
              ),
              alignment: Alignment.center,
              child: capitulo.capaUrl == null
                  ? Icon(Icons.image_outlined, size: 36, color: theme.colorScheme.onSurface.withOpacity(.5))
                  : null,
            ),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(capitulo.titulo, style: theme.textTheme.titleMedium),
                  const SizedBox(height: 6),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Text(capitulo.cta, style: theme.textTheme.labelLarge),
